...
% run Matpower PF
[ results, perdas ] = run_MatpowerPF(sistemaStr,alim);

% % run DistFlow PF
% if (alim.paramAG.PFtype == 'DistFlow')
%     
%     [ results, perdas ] = run_DistFlowPF(sistemaStr,alim);
%     
% end

end

function [ results, perdas ] = run_MatpowerPF(sistemaStr,alim) 
